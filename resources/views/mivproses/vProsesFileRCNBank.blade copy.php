...
<section class="content">
                ...
                <div class="modal-body">
                    <div class="callout callout-info">
                        ...
                        <div class="row" style="font-size:11px">
                                ...
                                <div class="col-3">
                                    <div class="input-group date" id="tglawalupload" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input"
                                            data-target="#tglawalupload" />
                                        <div class="input-group-append" data-target="#tglawalupload"
                                ...
                                <div class="col-3">
                                    <div class="input-group date" id="tglakhirupload" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input"
                                            data-target="#tglakhirupload" />
                                        <div class="input-group-append" data-target="#tglakhirupload"
                                            data-toggle="datetimepicker">
                                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                        </div>
                                    </div>
                            ...
                            <!-- <div class="row mt-2" style="font-size:11px">
                                ...
                                <div class="col-8">
                                    <select class="form-control" id="pilihusermiv">
                                        {{-- {{ dd(mycombo) }} --}}
                                        @foreach ($mycombo['combouserlogrcn'] as $item)
                                        <option value="{{ $item['USERID'] }}">{{ $item['USERID'] }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
    ...
    <script>
        $(function() {
            //Date picker
            $('#tglawalupload').datetimepicker({
                // format: 'L',
                format: 'DD MMMM YYYY',
            });

            $('#tglakhirupload').datetimepicker({
                // format: 'L',
                format: 'DD MMMM YYYY',
            });
            ...
            $("#tglawalupload").find("input").val(nowdate);
            $("#tglakhirupload").find("input").val(nowdate);
